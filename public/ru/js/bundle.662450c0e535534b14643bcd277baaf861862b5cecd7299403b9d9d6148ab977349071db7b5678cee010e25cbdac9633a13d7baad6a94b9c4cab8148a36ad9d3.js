...
const baseURL = 'http://192.168.33.200:64986';
...
const shortSearchQuery = 'Запрос очень короткий'
const typeToSearch = 'Напечатай для поиска';
const noMatchesFound = 'Нет результатов';
